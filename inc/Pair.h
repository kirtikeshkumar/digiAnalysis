...
public:
  ...
  /**
   * @brief Retrieve a pointer to HIT based on a channel selector.
   *
   ...
   */
  singleHits *GetHitPtr(Short_t Ch);
   ...
   * @return The corresponding pair Time Difference = Lower - Higher Channel.
   */
  Long64_t GetPairDelTime();
