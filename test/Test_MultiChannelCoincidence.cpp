...
int main(int argc, char *argv[])
{
    ...
    std::string fname = "/media/kirtikesh/UbuntuFiles/SDataF_NaI1342_02June26_1750_1345_1350_1350_NoSrc_Thresh_30_300_WAVES_Coinc_144ns_LeadPit_1.root";

    // Read to singleHits
    digiAnalysis::Analysis an(fname, 0, 0, 0);
    an.CreatePairs();
    std::vector<std::unique_ptr<digiAnalysis::Pair>> &vecOfPairs = an.GetPairsVec();
