...
namespace digiAnalysis
{
  ...
  Pair::Pair(const Pair &other)
      : hit1(other.hit1 ? std::make_unique<digiAnalysis::singleHits>(*other.hit1) : nullptr),
        hit2(other.hit2 ? std::make_unique<digiAnalysis::singleHits>(*other.hit2) : nullptr),
        SumEnergy(other.SumEnergy),
        PairDelTime(other.PairDelTime)
  {
  }
  ...
  singleHits *Pair::GetHitPtr(Short_t Sel)
  {
    ...
    {
    case -1:
      return (hit1->GetTimestamp() <= hit2->GetTimestamp()) ? hit1.get() : hit2.get();
    case -2:
      return (hit1->GetTimestamp() > hit2->GetTimestamp()) ? hit1.get() : hit2.get();
    case 0:
